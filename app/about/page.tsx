...
export default function AboutPage() {
  return <main className="about-page">
    ...
    <section className="section shell about-prose">
      ...
      <h2>Strong and Hevy exports</h2><p>Strong exports may require an explicit weight unit and distance unit when the CSV columns are unlabeled. Hevy workout exports use one row per set with workout timestamps, exercise title, set index/type, and optional kilograms, reps, distance, duration, and RPE. Empty cells remain unavailable; they are not treated as zero.</p>
