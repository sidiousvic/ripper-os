...
| 4 | Before sharing | Correct achievement peaks. | Complete in v0.2.3. Achievement peak now selects the highest historical metric value and retains its date; parser regression covers a 100 kg then 80 kg history. |
