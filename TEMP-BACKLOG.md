...
| 4 | Before sharing | Correct achievement peaks. | Complete in v0.2.3. Peak selection is fixed. Follow-up in progress: headline cards now show first-to-peak gains, exclude flat/non-improving comparisons, and label the latest value separately. |
