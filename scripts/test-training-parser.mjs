...
const duplicatePreview = createImportPreview(hashedStrong, "renamed-strong.csv", "add", [hashedStrong.importData]);
...
assert.deepEqual(overlap.conflict.dates, ['2019-01-02']);
...
console.log('History combiner: disjoint MF/Strong bench series and rollback-on-overlap passed');
